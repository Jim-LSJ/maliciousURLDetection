...
cross_valid = 5
threshold = 0.5
lightgbm_model_name = "Weight/mix60"
lightgbm_importance_name = "Feature_Importance/mix60"
result_name = "Result/mix60.csv"
trainning_loss_name = "Result/mix60_loss.png"
feature_rank_name = "Result/mix60_feature_rank_split.csv"
feature_rank_gain = "Result/mix60_feature_rank_gain.csv"
Label_name = "Label"
feature_name = [
                'HttpOnlyCount', 'div', 'a', 
                'script', 'external_script', 'internal_script', 
                'span', 'form', 'input', 
                'tag', 'non-class tag', 'class tag', 
                'domain_title_similarity', 'url_title_similarity', 
                'no_http-only_form', 'no_http-only_input',
                'RequestHeader', 'ResponseHeader', 'RedirectRequests',
